...
public class Recurrsion {
  ...
  public static void main(String[] args) {
    System.out.println("The total way are :-- " + tailing(4));
    
  }
}

NEXT RECURSSION QUESTION REMOVING DUPLICATES FROM STRING

public class Recurrsion {
  public static void duplicate(String str , int indx , StringBuilder newStr , boolean map[]){
    if (indx == str.length()) {
    ...
    if (map[currChar -'a'] == true) {
      duplicate(str, indx+1, newStr, map);
      
    }else{
      map[currChar-'a'] = true;
      duplicate(str, indx+1, newStr.append(currChar), map);
    }
